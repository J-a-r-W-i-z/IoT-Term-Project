...
//    ) {
//        super<FragmentActivity>.onRequestPermissionsResult(requestCode, permissions, grantResults)
...
//    }
    ...
    protected fun saveToGallery(chart: Chart<*>, name: String) {
        ...
        else Toast.makeText(applicationContext, "Saving FAILED!", Toast.LENGTH_SHORT)
            .show()
    }
